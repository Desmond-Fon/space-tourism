...
const Mars = () => {
    return ( <>
        ...
        <div className="bg-[url('../../public/assets/destination/background-destination-mobile.jpg')] md:bg-[url('../../public/assets/destination/background-destination-tablet.jpg')] lg:bg--[url('../../public/assets/destination/background-destination-desktop.jpg')] bg-center bg-cover">
          ...
          <h1 className='font-bellefair text-center leading-[64.2px] text-cream text-[56px] mt-[20px] mb-[1px]'>MARS</h1>
          <p className='font-barlow text-center px-[24px] text-skyBlue text-[15px] leading-[25px] font-[400]'>Don’t forget to pack your hiking boots. You’ll need them to tackle Olympus Mons, the tallest planetary mountain in our solar system. It’s two and a half times the size of Everest!</p>
          ...
          <p className='pb-[32px] font-bellefair text-[28px] text-center leading-[32.1px] text-cream'>225 MIL. KM</p>

          <p className='mb-[12px] text-center text-[14px] leading=[16.8px] tracking-[2.36px] text-skyBlue font-barlow'>EST. TRAVEL TIME</p>

          <p className='pb-[58px] font-bellefair text-[28px] text-center leading-[32.1px] text-cream'>9 MONTHS</p>
