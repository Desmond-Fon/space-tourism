...
const Europa = () => {
    return ( <>
        ...
        <div className="bg-[url('../../public/assets/destination/background-destination-mobile.jpg')] md:bg-[url('../../public/assets/destination/background-destination-tablet.jpg')] lg:bg--[url('../../public/assets/destination/background-destination-desktop.jpg')] bg-center bg-cover">
          <Header />
          ...
          <h1 className='font-bellefair text-center leading-[64.2px] text-cream text-[56px] mt-[20px] mb-[1px]'>EUROPA</h1>
          <p className='font-barlow text-center px-[24px] text-skyBlue text-[15px] leading-[25px] font-[400]'>The smallest of the four Galilean moons orbiting Jupiter, Europa is a winter lover’s dream. With an icy surface, it’s perfect for a bit of ice skating, curling, hockey, or simple relaxation in your snug wintery cabin.</p>

          <div className='flex justify-center items-center my-[32px]'>
            <div className='h-[1px] w-[327px] bg-lineColor'></div>
          </div>

          <p className='mt-[32px] mb-[12px] text-center text-[14px] leading=[16.8px] tracking-[2.36px] text-skyBlue font-barlow'>AVG. DISTANCE</p>
          <p className='pb-[32px] font-bellefair text-[28px] text-center leading-[32.1px] text-cream'>628 MIL. KM</p>

          <p className='mb-[12px] text-center text-[14px] leading=[16.8px] tracking-[2.36px] text-skyBlue font-barlow'>EST. TRAVEL TIME</p>

          <p className='pb-[58px] font-bellefair text-[28px] text-center leading-[32.1px] text-cream'>3 YEARS</p>
