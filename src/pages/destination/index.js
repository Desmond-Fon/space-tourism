...
const Destination = () => {
    return ( <>
        ...
        <div className="bg-[url('../../public/assets/destination/background-destination-mobile.jpg')] md:bg-[url('../../public/assets/destination/background-destination-tablet.jpg')] lg:bg--[url('../../public/assets/destination/background-destination-desktop.jpg')] bg-center bg-cover  ">
          ...
          <h1 className='font-bellefair text-center leading-[64.2px] text-cream text-[56px] mt-[20px] mb-[1px]'>MOON</h1>
          <p className='font-barlow text-center px-[24px] text-skyBlue text-[15px] leading-[25px] font-[400]'>See our planet as you’ve never seen it before. A perfect relaxing trip away to help regain perspective and come back refreshed. While you’re there, take in some history by visiting the Luna 2 and Apollo 11 landing sites.</p>
          ...
          <p className='pb-[32px] font-bellefair text-[28px] text-center leading-[32.1px] text-cream'>384,400 KM</p>

          <p className='mb-[12px] text-center text-[14px] leading=[16.8px] tracking-[2.36px] text-skyBlue font-barlow'>EST. TRAVEL TIME</p>

          <p className='pb-[58px] font-bellefair text-[28px] text-center leading-[32.1px] text-cream'>3 DAYS</p>
