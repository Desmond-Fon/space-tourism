...
const Technology = () => {
  return (
    <>
      ...
      <div className="bg-[url('../../public/assets/technology/background-technology-mobile.jpg')] md:bg-[url('../../public/assets/technology/background-technology-tablet.jpg')] lg:bg--[url('../../public/assets/technology/background-technology-desktop.jpg')] bg-center bg-cover w-[100vw] h-full md:h-[100vh]">
        <Header />
        ...
        <div className="mb-[34px] w-full md:mb-[56px]">
          <Image src={vehicle} alt="" className="w-full md:h-[310px]"/>
        </div>
        ...
        <h1 className="font-bellefair text-[24px] leading-[27.5px] text-cream text-center mb-[16px] md:text-[40px] md:leading-[46px]">LAUNCH VEHICLE</h1>

        <p className="px-[24px] pb-[56px] font-barlow text-[15px] leading-[25px] text-center text-skyBlue md:px-[155px] md:pb-[97px] md:text-[16px] md:leading-[28px]">A launch vehicle or carrier rocket is a rocket-propelled vehicle used to carry a payload from Earth&apos;s surface to space, usually to Earth orbit or beyond. Our WEB-X carrier rocket is the most powerful in operation. Standing 150 metres tall, it&apos;s quite an awe-inspiring sight on the launch pad!</p>
